...
class ChatbotConfig(BaseModel):
    ...
    model_name: str = os.getenv("CHATBOT_MODEL_NAME", "Qwen/Qwen2.5-3B-Instruct")

    # === Generation params ===
    max_tokens_short: int = 256
    max_tokens_medium: int = 768
    max_tokens_long: int = 1024
    ...
    rag_context_max_chars: int = int(os.getenv("RAG_CONTEXT_MAX_CHARS", "900"))
