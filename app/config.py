...
# === RAG Configuration ===
# Multilingual embedding — jauh lebih bagus untuk Bahasa Indonesia
EMBEDDING_MODEL_NAME = os.getenv(
    "EMBEDDING_MODEL_NAME",
    "intfloat/multilingual-e5-base"   # 768 dim, support 100+ bahasa
)

# Re-ranker model — cross-encoder untuk re-rank top-K chunks
RERANKER_MODEL_NAME = os.getenv(
    "RERANKER_MODEL_NAME",
    "BAAI/bge-reranker-v2-m3"   # multilingual, ~568MB
)

# Hybrid search weights — total = 1.0
RAG_BM25_WEIGHT = float(os.getenv("RAG_BM25_WEIGHT", "0.4"))
RAG_DENSE_WEIGHT = float(os.getenv("RAG_DENSE_WEIGHT", "0.6"))

# Retrieval params
RAG_TOP_K_RETRIEVE = int(os.getenv("RAG_TOP_K_RETRIEVE", "10"))   # ambil 10, rerank → top 3
RAG_TOP_K_FINAL = int(os.getenv("RAG_TOP_K_FINAL", "3"))
RAG_CONTEXT_MAX_CHARS = int(os.getenv("RAG_CONTEXT_MAX_CHARS", "900"))

# Path untuk BM25 index (persistent storage)
BM25_INDEX_PATH = os.getenv("BM25_INDEX_PATH", "models/bm25_index.pkl")
